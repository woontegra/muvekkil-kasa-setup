...
for (const key of ["ELECTRON_RUN_AS_NODE", "MKD_E2E_VEKALET_OFIS", "MKD_TEST_DB", "ELECTRON_RENDERER_URL"]) {
  delete env[key];
}
env.MKD_GUI_LIVE_TEST = "1";

console.log("=== MKD Canlı GUI Smoke Test ===");
