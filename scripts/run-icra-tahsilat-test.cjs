...
for (const key of ["ELECTRON_RUN_AS_NODE", "MKD_E2E_VEKALET_OFIS", "MKD_GUI_LIVE_TEST", "MKD_TEST_DB", "ELECTRON_RENDERER_URL", "MKD_VEKALET_UYARI_TEST"]) {
  delete env[key];
}
env.MKD_ICRA_TAHSILAT_TEST = "1";

console.log("=== MKD İcra Tahsilat Testi ===");
