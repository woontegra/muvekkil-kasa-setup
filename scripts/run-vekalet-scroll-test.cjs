...
for (const key of ["ELECTRON_RUN_AS_NODE", "MKD_E2E_VEKALET_OFIS", "MKD_GUI_LIVE_TEST", "MKD_TEST_DB", "ELECTRON_RENDERER_URL"]) {
  delete env[key];
}
env.MKD_VEKALET_SCROLL_TEST = "1";

console.log("=== MKD Vekalet Scroll Test (1280×900) ===");
